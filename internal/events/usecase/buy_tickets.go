...
type BuyTicketsUseCase struct {
	...
	partnerFactory services.PartnerFactory
}

func NewBuyTicketsUseCase(repo domain.EventRepository, partnerFactory services.PartnerFactory) *BuyTicketsUseCase {
...
func (uc *BuyTicketsUseCase) Execute(input BuyTicketsInputDTO) (*BuyTicketsOutputDTO, error) {
	...
	req := &services.ReservationRequest{
